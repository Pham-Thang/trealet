...
<div class="container" id="myContainer">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    ...
                    <ul class="nav nav-tabs" id="myTab" role="tablist">
                        <li class="nav-item">
                            <a class="nav-link active" id="home-tab" data-toggle="tab" href="#home" role="tab" aria-controls="home" aria-selected="true">Di sản số</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="profile-tab" data-toggle="tab" href="#profile" role="tab" aria-controls="profile" aria-selected="false">Tương tác</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false"></a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact" aria-selected="false">Trình chiếu ảnh</a>
                        </li>
                        <li class="nav-item">
                            <a class="nav-link" id="database-tab" data-toggle="tab" href="#database" role="tab" aria-controls="database" aria-selected="false">Kho dữ liệu</a>
                        </li>
                    </ul>
                                ...
                                <li id="picture_input" class="list-group-item rounded-0 d-flex align-items-center justify-content-between">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label" for="customRadio1">
                                            ...
                                            <input type="file" class="form-control" id="customFile_uploadImage" />
                                ...
                                <li class="list-group-item rounded-0 d-flex align-items-center justify-content-between">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label" for="customRadio2">
                                            ...
                                            <input type="file" class="form-control" id="customFile_uploadVideo" />
                                ...
                                <li id="audio_input" class="list-group-item rounded-0 d-flex align-items-center justify-content-between">
                                    <div class="custom-control custom-radio">
                                        ...
                                        <label class="custom-control-label" for="customRadio7">
                                            ...
                                            <input type="file" class="form-control" id="customFile_uploadAudio" />
    ...
    <center>
        <h1><input placeholder="Hãy điền tên trealet" class="form-control" id="trealet_title" style="text-align:center; height: 60px; width: 50%"></h1>
        <h4 class="text-muted"><input placeholder="Hãy điền tên của tác giả " id="trealet_author" class="form-control" style="text-align:center; width: 30%"></h4>
    </center>
    <div class="card">
        <h4 class="card-header">Lời giới thiệu</h4>
        <div class="card-body"><textarea id="trealet_desc" class="form-control rounded-0"></textarea>
            <p></p>
