                ...
                <div class="modal-content">
                    ...
                    <div class="modal-body">
                        ...
                        <ul class="nav nav-tabs" id="myTab" role="tablist">
                            ...
                            <li class="nav-item">
                                <a class="nav-link" id="contact-tab" data-toggle="tab" href="#contact" role="tab" aria-controls="contact"
                                   aria-selected="false">Trình chiếu ảnh</a>
                            </li>
                            <li class="nav-item">
                                <a class="nav-link" id="database-tab" data-toggle="tab" href="#database" role="tab" aria-controls="database"
                                   aria-selected="false">Kho dữ liệu</a>
                            </li>
                        </ul>
                                    ...
                                    <li  id = "picture_input" style="border-width: 1px" class="list-album rounded-0 d-flex align-items-center justify-content-between">
                                        <div class="">
                                            ...
                                            <label class="" style="" for="">
                                                ...
                                                <textarea style="height: 100px" id="customText_1" placeholder= "Hãy viết mô tả cho ảnh này!"  class ="form-control"></textarea>
            ...
            save.addEventListener('click', function (){
                ...
                for (const element of list_card) {
                    ...
                    if (element.getElementsByClassName("card-body")[0].getAttribute("type") == "picture") {
                        ...
                        itemAdd["description_image"] = element.getElementsByClassName("card-body")[0].getElementsByTagName("div")[0].textContent;
                    ...
                    if (element.getElementsByClassName("card-body")[0].getAttribute("type") == "video") {
                        ...
                        ;
                        itemAdd["description_video"] = element.getElementsByClassName("card-body")[0].getElementsByTagName("div")[0].textContent;
                    ...
                    if (element.getElementsByClassName("card-body")[0].getAttribute("type") == "audio") {
                        ...
                        ;
                        itemAdd["description_audio"] = element.getElementsByClassName("card-body")[0].getElementsByTagName("div")[0].textContent;
                ...
                var public_mode = $('#select_mode_public').find(":selected").text();
                var key = $('#title').val();
                    ...
                    for (i = 0; i < selected.length; i++) {
                        if (selected[i].checked) {
                            ...
                            if (selected[i].value == "Video_input") {
                                ...
                                div.appendChild(description);
                                video.setAttribute("blob_value", video_blob) ;
                                selectedItem.appendChild(video);
                                selectedItem.setAttribute("type", "video");
                                let br = document.createElement("br");
                                selectedItem.appendChild(br)
                                selectedItem.appendChild(div)
                                let close_btn = document.getElementById('close_modal');
                                close_btn.click();
                                var video_blob_index = selectedItem.parentElement.id+ dict_length;
