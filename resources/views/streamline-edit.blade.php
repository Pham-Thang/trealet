    ...
    <div class="container">
        <div class="modal fade" id="exampleModalCenter" tabindex="-1" role="dialog" aria-labelledby="exampleModalCenterTitle" aria-hidden="true">
            ...
            <center><h1><input placeholder="Hãy điền tên trealet" class = "form-control" style="text-align:center; height: 60px; width: 50%"></h1>
                <h4 class="text-muted"><input placeholder= "Hãy điền tên của tác giả "  class ="form-control" style="text-align:center; width: 30%"></h4></center>
            <div class="card">
                <h4 class="card-header">Lời giới thiệu</h4>
                <div class="card-body"><textarea class="form-control rounded-0"></textarea><p></p>
        ...
        <form class="form-inline mb-4" id="form" >
            ...
            <script>
                ...
                window.addEventListener('load', function() {
                    ...
                    document.querySelector('#customFile_uploadImage').addEventListener('change', function() {
                ...
                window.addEventListener('load', function() {
                    ...
                    document.querySelector('#customFile_uploadVideo').addEventListener('change', function() {
                    ...
                    for (i = 0; i < selected.length; i++) {
                        if (selected[i].checked) {
                            ...
                            if (selected[i].value == "Picture_upload") {
                                ...
                                iframe.setAttribute("src", "/input-picture");
                            ...
                            if (selected[i].value == "Audio_input") {
                                let iframe = document.createElement("iframe")
                                iframe.setAttribute("style", "position: relative; width: 90%; height: 350px;");
                                iframe.setAttribute("src", "/input-audio");
                                iframe.setAttribute("frameborder", "0");
                                iframe.setAttribute("allow", "camera");
                                iframe.setAttribute("onload", "this.style.height=(this.contentWindow.document.body.scrollHeight+200)+'px';");
                                selectedItem.appendChild(iframe)
                            ...
                            if (selected[i].value == "Form_input") {
                                ...
                                iframe.setAttribute("src", "/input-form");
