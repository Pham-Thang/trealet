...
btnSubmit.onclick = () => {
	var values		  = {};
	values.user_id 	  = <?php echo $user_id;?>;
	...
	var params = 'data=' + JSON.stringify(values)+'&_token='+'<?php echo e(csrf_token()); ?>';
	http.send(params);
...
<?php /**PATH /var/www/html/trealet.com/audiences/resources/views/trealets/input-qr.blade.php ENDPATH**/ ?>