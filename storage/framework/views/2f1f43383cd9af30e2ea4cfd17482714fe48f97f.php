<?php $__env->startComponent('mail::layout'); ?>
    ...
    <?php $__env->slot('header'); ?>
        <?php $__env->startComponent('mail::header', ['url' => config('app.url')]); ?>
            <img src="<?php echo e(url('assets/img/vanguard-logo.png')); ?>" alt="<?php echo e(config('app.name')); ?>" height="50">
...
<?php endif; ?>
<?php echo $__env->renderComponent(); ?>
<?php /**PATH C:\Users\NDT\PycharmProjects\trealet\audiences\resources\views/vendor/mail/html/message.blade.php ENDPATH**/ ?>