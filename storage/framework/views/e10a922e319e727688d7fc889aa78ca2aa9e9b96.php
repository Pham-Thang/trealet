                    ...
                    <tr>
                        <td style="<?php echo e($style['email-masthead']); ?>">
                            <a style="<?php echo e($fontFamily); ?> <?php echo e($style['email-masthead_name']); ?>" href="<?php echo e(url('/')); ?>" target="_blank">
                                <img src="<?php echo e(url('assets/img/vanguard-logo.png')); ?>" alt="Vanguard" height="60">
                                                ...
                                                <tr>
                                                    <td style="<?php echo e($fontFamily); ?>">
                                                        <p style="<?php echo e($style['paragraph-sub']); ?>">
                                                            <?php echo app('translator')->get("If you're having trouble clicking the \":button\" button, copy and paste the URL below into your web browser:", ['button' => $actionText]); ?>
                                                        </p>
...
<?php /**PATH C:\Users\NDT\PycharmProjects\trealet\audiences\resources\views/vendor/notifications/email.blade.php ENDPATH**/ ?>