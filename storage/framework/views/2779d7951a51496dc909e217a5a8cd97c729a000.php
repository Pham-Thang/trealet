        ...
        <div class="form-group mb-4">
            <div class="d-flex align-items-center">
                <div class="switch">
                    ...
                    <?php echo Form::checkbox('throttle_enabled', 1, setting('throttle_enabled'), ['class' => 'switch', 'id' => 'switch-throttle']); ?>
...
<?php /**PATH /var/www/html/trealet.com/audiences/resources/views/settings/partials/throttling.blade.php ENDPATH**/ ?>