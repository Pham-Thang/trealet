...
<nav class="col-md-2 sidebar">
    <div class="user-box text-center pt-5 pb-3">
		...
		<h5 class="my-3">
            <a href="login"><i class="fas fa-sign-in-alt"></i> <?php echo app('translator')->get('Login'); ?></a>
        </h5>
    </div>
</nav>
<?php endif; ?><?php /**PATH C:\Users\NDT\PycharmProjects\trealet\audiences\resources\views/partials/sidebar/main.blade.php ENDPATH**/ ?>