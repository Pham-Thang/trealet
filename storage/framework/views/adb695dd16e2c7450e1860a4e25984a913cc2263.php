<nav class="navbar fixed-top align-items-start navbar-expand-lg pl-0 pr-0 py-0" >
    ...
    <div class="navbar-brand-wrapper d-flex align-items-center justify-content-center">
        <a class="navbar-brand mr-0" href="<?php echo e(url('/')); ?>">
            <img src="<?php echo e(url('assets/img/trealet-logo.png')); ?>" class="logo-lg" height="60" alt="<?php echo e(setting('app_name')); ?>">
...
<?php /**PATH C:\Users\NDT\PycharmProjects\trealet\audiences\resources\views/partials/navbar.blade.php ENDPATH**/ ?>